package co.edu.unal.reto7_online;
...
public class MainActivity extends AppCompatActivity {
    ...
    DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReferenceFromUrl("https://reto7-627fc-default-rtdb.firebaseio.com/");
